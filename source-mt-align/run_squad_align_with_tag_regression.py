...
def compute_predictions_logits(
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        for (feature_index, feature) in enumerate(features):
            ...
            tag = result.tag_logits[0]    # save the original probability
        ...
        if version_2_with_negative:
            ...
            if len(nbest) == 1:
                nbest.insert(0, _NbestPrediction(text="empty", start_logit=0.0, end_logit=0.0,
                                                 start_index=-1, end_index=-1, probability=0.0,
                                                 # tag=reverse_tag_map[-1]))
                                                 tag=-1))
...
def main():
    ...
    assert config.tag_map == {'OK': 0, 'BAD': 1, 'None': -1}, 'Regression mode requires tag_map to be like this.'
    ############################################
    #   @wyzypa End
    ############################################
