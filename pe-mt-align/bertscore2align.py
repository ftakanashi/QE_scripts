...
def sent_encode(tokenizer, sent):
    ...
    # def _map_offset(orig_tokens, pieced_tokens):
    #     mapping = {}
    #     pieced_i = 0
    #     for orig_i, orig_token in enumerate(orig_tokens):
    #         tmp_token = pieced_tokens[pieced_i]
    ...
    if sent == "":
        ...
        # piece_offset_mapping = _map_offset(sent.split(), pieced_tokens)
        # print(piece_offset_mapping)

        piece_offset_mapping = map_offset(sent, tokenizer)
...
def parse_args():
    ...
    parser.add_argument('--do-lower-case', action='store_true', default=False,
                        help='Set the flag if uncased model is used.')
