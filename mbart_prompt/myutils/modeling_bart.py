...
from transformers.modeling_bart import PretrainedBartModel, BartConfig, BartEncoder, BartDecoder
...
class MBartForConditionalGeneration(PretrainedBartModel):
    '''
    This class is modified from transformers.modeling_bart.BartForConditionalGeneration
    '''
        ...
        **unused,
        ...
        if labels is not None:
            ...
            if decoder_input_ids is None:
                ...
                decoder_input_ids = shift_tokens_right(labels, -100)
